...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#00248c] text-white py-12 relative overflow-hidden">
      {/* Floating elements */}
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-20 right-10 w-32 h-32 bg-blue-500/10 rounded-full blur-3xl animate-float"></div>
        <div className="absolute bottom-20 left-10 w-40 h-40 bg-yellow-500/10 rounded-full blur-3xl animate-float-delayed"></div>
      </div>
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Column 1: About */}
          <div>
            <div className="w-[140px] h-[35px] relative mb-4">
              <Image 
            ...
            <p className="text-sm text-white/80">
              La plataforma líder para calificar profesores universitarios en Venezuela.
